  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
      ...
      items-center py-4 px-6 md:px-20 lg:PX-32 bg-transparent'>
        <img src='https://cdn-icons-png.flaticon.com/128/13979/13979460.png' alt="block" />
        ...
        rounded-full hover:bg-blue-500 text-white-500'>Sign up</button>
      ...
      <div className={`md:hidden ${showMobileMenu ? 'fixed w-full' : 'h-0 w-0'}  right-0 top-0 bottom-0 overflow-hidden bg-white transition-all`}>
        ...
        <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
            ...
            <a onClick={()=>setShowMobileMenu(false)} href="#Header" className='px-4 py2 rounded-full inline-block '>Sign Up</a>
        </ul>
      </div>
    </div>
  )
